...
namespace AppCenterEditor
{
    public class AppCenterEditorSDKTools : Editor
    {
        ...
        public static void RemoveSdk(bool prompt = true)
        {
            ...
            EdExLogger.LogWithTimeStamp("Removing SDK...");
            ...
            if (FileUtil.DeleteFileOrDirectory(AppCenterEditorPrefsSO.Instance.SdkPath))
            {
                ...
                EdExLogger.LogWithTimeStamp("App Center SDK removed.");
        ...
        private static void CheckSdkVersion()
        {
            ...
            foreach (var assembly in AppDomain.CurrentDomain.GetAssemblies())
            {
                ...
                catch (ReflectionTypeLoadException)
                {
                    ...
                    {
                        EdExLogger.LogWarning("App Center Editor Extension error, failed to access the main CSharp assembly that probably contains App Center SDK");
                    }
                    continue;
                }
            }
